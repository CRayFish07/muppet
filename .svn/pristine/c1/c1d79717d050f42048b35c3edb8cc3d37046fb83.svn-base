 ...
 *
 */
public class StandardAutoGenereateTableXMLConfig extends AbstractConfig implements AutoGenerateConfig{
	...
	public StandardAutoGenereateTableXMLConfig(XMLConfigResource xmlResource){
		super(xmlResource);
